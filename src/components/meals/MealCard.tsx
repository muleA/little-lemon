    ...
    <article className="md:w-100 w-full mt-100 my-2 mb-2 h-full px-2 bg-[#edefee] ">
      ...
      <div className="flex items-center justify-between">
        <div className="flex flex-col">
          ...
          <h6 className="mr-1 rounded-full text-primary-900 px-4 py-1">
            {meal.price}
          </h6>
        </div>
        <div className="font-roboto-light mb-2 text-center flex gap-6 rounded-lg p-2">
          <button
            ...
            className="inline-block rounded-full hover:bg-grayBackground hover:text-white hover:bg-primary-700	
            mt-8 px-4 py-2 bg-grayBackground border-yellow-400  text-white border border-transparent hover:border-yellow-400 
      ...
      <div className="mx-auto flex flex-col gap-3">
        <h6 className="p-2 text-sm text-gray-900">{meal.description}</h6>
      </div>
    </article>
  );
};
