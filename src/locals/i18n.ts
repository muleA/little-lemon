...
import translationEN from "./en/translation.json"; // Import language file for English
import translationFR from "./am/translation.json"; // Import language file for French
